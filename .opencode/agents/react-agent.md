...
3. Follow all best practices defined in the React development rules at `.opencode/rules/react_rules.md`
...
**CRITICAL**: Always consult the comprehensive React development rules at `.opencode/rules/react_rules.md` for detailed guidance, best practices, and requirements not fully covered in this agent definition. The rules file contains authoritative information that supersedes any conflicting guidance below.
