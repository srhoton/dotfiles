---
description: Read a project description from a file and dispatch to routing-agent for SDLC flow
agent: routing-agent
---

Read the project description from the file at path: $ARGUMENTS

Then use the Task tool to dispatch to the `routing-agent` subagent with the contents of that file as the project request.
